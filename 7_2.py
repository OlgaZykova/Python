...
# которая может иметь определенное название. К типам одежды в этом проекте относятся
...
my_coat = Coat(34)
my_suit = Suit(1.7)
print(f'Количество ткани для пальто: {my_coat.tissue}')
print(f'Количество ткани для костюма: {my_suit.tissue}')